...
class SleepTrackerViewModel(
    ...
    // End Sleep >> use uiScope in Main Thread and access the update in other Thread to do the hard/long work
    fun onStopTracking() {
        uiScope.launch {
    ...
    val navigateToSleepDetailQuality : LiveData<Long>
    ...
    fun onSleepNightQualityNavigate() {
